...
from game_logic.stages.main_menu_stage.settings.main_menu import MAIN_MENU_BUTTONS, exit_warning, \
...
class MainMenu(MenuUI):
    def __init__(self):
        ...
        self.add_elements_to_controller(*self._elements, LANG_RELOAD_WARN, enter_focus=self.start)
