...
from constants.stages.localizations.main_menu import MainMenuLocPaths
...
MAIN_MENU_BUTTONS = {
    'start': {
        'kwargs': {
            ...
            'p_y_pos': 0.450,
            'active': 1,
            'text': MainMenuLocPaths.StartRound,
    ...
    'host_game_stage': {
        'kwargs': {
            'x': HALF_SCREEN_W - ButtonsConst.DEFAULT_BUTTON_X_SIZE // 2,
            'p_y_pos': 0.510,
            'text': MainMenuLocPaths.HostGame,
            'on_click_action': STAGES.set_load_host_stage,
    ...
    'multiplayer': {
        'kwargs': {
            'x': HALF_SCREEN_W - ButtonsConst.DEFAULT_BUTTON_X_SIZE // 2,
            'p_y_pos': 0.570,
            'text': MainMenuLocPaths.Multiplayer,
            'on_click_action': STAGES.set_join_menu_stage,
    ...
    '_settings': {
        ...
        'kwargs': {
            'x': HALF_SCREEN_W - ButtonsConst.DEFAULT_BUTTON_X_SIZE // 2,
            'p_y_pos': 0.630,
            'text': MainMenuLocPaths.Settings,
...
LANG_RELOAD_WARN = DisappMessage(text=MainMenuLocPaths.LangDisappMsg,
