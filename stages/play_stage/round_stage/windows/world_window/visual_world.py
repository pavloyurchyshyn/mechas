...
from game_logic.components.world.logic_world.tile import WorldTile
from game_logic.components.world.logic_world.abstract_world import AbstractWorld
...
class VisualWorld(AbstractWorld):
    ...
    def get_tile_by_coords(self, coordinates) -> Hexagon:
        return self.tiles_dict.get(coordinates)
