...
from stages.play_stage.round_lobby_stage.settings.exit_pop_up import *


class LobbyExitPopUp(Rectangle, LocalizationMixin, metaclass=Singleton):
    name = LobbyUINames.ExitPopUp
    id = LobbyUINames.ExitPopUp
    ...
    def render(self):
        ...
        EXIT_MESSAGE_SURF = custom_font(25).render(self.get_text_with_localization(LobbyLocPaths.ExitPopUp), 1,
                                                   (255, 255, 255))
